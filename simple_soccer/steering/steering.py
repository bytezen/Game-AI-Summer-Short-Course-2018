...
##        self.view_distance = BehaviorParams.view_distance
    ...
    def side_component(self):
        return self._entity.side.dot(self.steering_force.normalize()) * self._entity.max_turn_rate
    ...
    def separation_on(self) : self.on(Behavior.SEPARATION)
    def separation_off(self) : self.off(Behavior.SEPARATION)
