...
TITLE = 'Steering Behavior - Interpose'    
WIDTH = 800
HEIGHT = 600
...
target2 = Vehicle(world=world, \
                  center=(WIDTH*0.25,HEIGHT*0.3), \
                  mass=MASS, \
                  max_speed=MAX_SPEED, \
                  max_force=MAX_FORCE, \
                  max_turn_rate=MAX_TURN_RATE, \
...
def start():
    ...
    world.add_agent(target1)
    world.add_agent(target2)
